...
namespace ssl.Modules.Items
{
    ...
    public class ItemRegistry
    {
        ...
        private void RegisterItems()
        {
            ...
            Add(new ItemFoodData("food.wine", "Wine", "models/citizen_props/wineglass02/wineglass01gib01_lod01.vmdl",
                5));
            ...
            //Cleaning Items
            Add(new ItemMopData("item.mop", "Mop", "models/knife/knife.vmdl"));
        }
    }
}